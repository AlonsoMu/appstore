...
class Producto extends Conexion{
  ...
  public function especificarProducto($datos = []){
    try {
      $consulta = $this->conexion->prepare("CALL spu_productos_especificar(?)");
      $consulta->execute(
        array(
          $datos['idproducto']
        )
  ...
  public function registrarEspecificacion($datos = []){
    try {
      $consulta = $this->conexion->prepare("CALL spu_especificaciones_registrar(?,?,?,?)");
      $consulta->execute(
        array(
          $datos['idproducto'],
          $datos['clave'],
